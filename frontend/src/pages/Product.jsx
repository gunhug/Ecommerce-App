        ...
        <div className="flex gap-10 flex-col xl:flex-row rounded-2xl p-3 mb-6">
          ...
          <div className="flex-[1.5] rounded-2xl px-5 py-3 bg-primary">
            ...
            <div className="flex items-baseline gap-x-5">
              <div className="flex items-center gap-x-2 text-[#222529]">
                <div className="flex gap-x-2 text-[#222529]">
                  <FaStar />
                  <FaStar />
                  <FaStar />
                  <FaStar />
            ...
            <div className="flex items-center gap-x-4">
              <button
                ...
                className="btn-secondary !rounded-lg sm:w-1/2
                flexCenter gap-x-2 capitalize cursor-pointer"
              >
            ...
            <div className="mt-2 flex flex-col gap-1 text-[#7B7B7B] text-[14px]">
