        ...
        <div className='bg-primary mb-16'>
            <div className='max-padd-container py-10'>
                ...
                <div className='flexStart gap-x-4'>
                    ...
                    <h5 className='medium-15 text-[#222529] relative 
                    bottom-1.5 '>
                ...
                <div className='mt-6'>
                    {cartData.map((item, i) => {
                        ...
                        return (
                            <div key={i} className='bg-white p-2 mb-3
                            rounded-lg'>
                                <div className='flex items-center gap-x-3'>
                                    ...
                                    <div className='flex flex-col w-full'>
                                        <div className='flexBetween'>
                                            ...
                                            <FaRegWindowClose 
                                                onClick={() => {
                                                    console.log("Click detected for item:", item._id, item.color)
                                        ...
                                        <p className='bold-14 my-1.5'>{item.color}</p>
                                        
                                        <div className='flexBetween'>
                                            <div className='flex items-center ring-1 ring-slate-900/5
                                            rounded-full overflow-hidden bg-primary'>
                                                <button onClick={()=>decrement(item._id, item.color)} className='p-1.5 bg-white text-[#222529]
                                                rounded-full shadow-md'>
                                                    <FaMinus className='text-xs'/>
                                                </button>
                                                <p className='px-2'>{quantities[key]}</p>
                                                <button onClick={()=>increment(item._id, item.color)} className='p-1.5 bg-white text-[#222529]
                                                rounded-full shadow-md'>
