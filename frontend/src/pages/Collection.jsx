...
const Collection = () => {
  ...
  useEffect(() => {
    ...
    setCurrentPage(1); //Rết to first page when filters change
    ...
    <div className="max-padd-container !px-0">
      <div className="flex flex-col sm:flex-row gap-8 mb-16">
        ...
        <div className="min-w-72 bg-primary p-4 pt-8 pl-6 lg:pl-12">
          ...
          <div className="pl-5 py-3 mt-4 bg-white rounded-xl">
            ...
            <div className="flex flex-col gap-2 text-sm font-light">
              {[
                ...
                <label key={cat} className="flex gap-2 medium-14 text-gray-300">
                  <input
          ...
          <div className="px-4 py-3 mt-6 bg-white rounded-xl">
            ...
            <select
              ...
              className="border border-slate-900/5 outline-none
              text-[#7B7B7B] medium-14 h-8 w-full rounded px-2"
            >
        ...
        <div className="pr-5 rounded-l-xl">
          ...
          md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 gap-y-6"
          >
          ...
          <div className="flexCenter flex-wrap gap-4 mt-14 mb-10">
            ...
            {Array.from({ length: totalPages }, (_, index) => (
              <button
                ...
                className={`${
                  currentPage === index + 1 && "!bg-[#222529] text-white"
                } btn-light !py-1 !px-3`}
              >
                {index + 1}
              </button>
