...
const ProductFeatures = () => {
  return (
    <div className='bg-primary rounded-xl mt-6'>
      ...
      lg:grid-cols-3 gap-12 rounded-xl'>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          <div className='text-3xl'> <TbArrowBackUp className='mb-3 text-yellow-500' /></div>
            ...
            adipisicing elit. Voluptatem caque corrupti
            asperiores animi, praesentium temporibus !</p>
          </div>
        </div>

        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          <div className='text-3xl'> <TbTruckDelivery className='mb-3 text-yellow-500' /></div>
            <div>
            <h4 className='h4 capitalize'>Fast Delivery</h4>
            <p>Lorem ipsum dolor sit amet
            consectetur adipiscing elit.
            Voluptatem caque corrupti
            asperiores animi, praesentium
            temporibus!</p>
          </div>
        </div>
